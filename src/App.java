...
public class App {
	...
	public static void test() {
		...
		String ans1 = ans.nextLine();
			if( ans1.equals("Yes") || ans1.equals("yes")) {
				...
				System.out.println(" What specie is " + hero1.name + " ?");
				...
				System.out.println(" You can choose between: Knight || Wizard || Paladin || Druid ");
				...
				prof5 = prof.equals("Paladin");
				prof6 = prof.equals("paladin");
				prof7 = prof.equals("Druid");
				prof8 = prof.equals("druid");
	...
	/* zawartoϾ przeniesiona do test()
	System.out.println(" Welcome to RPG Hero Generator ");
	System.out.println(" Do You want to create a new hero? ");
	...
	String ans1 = ans.nextLine();
		if( ans1.equals("Yes") || ans1.equals("yes")) {
			...
			System.out.println(" You can choose between: Knight || Wizard || Paladin || Barbarian ");
